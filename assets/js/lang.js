...
const translations = {
    fr: {
        ...
        // OtherPeoplesPlaces project  
        'opp.title': 'Other Peoples Places Finds',
        'opp.lead': 'Briser les frontières dans le design de logements modulaires haut de gamme',
        'opp.intro.p1': 'Other Peoples Places représente une approche révolutionnaire du logement modulaire haut de gamme, combinant un design innovant avec la durabilité et la flexibilité.',
        'opp.intro.p2': 'Le projet explore de nouvelles possibilités dans la construction préfabriquée, créant des espaces de vie qui sont à la fois luxueux et respectueux de l\'environnement.',
        'opp.design.title': 'Design innovant',
        'opp.design.p1': 'Le design intègre des systèmes modulaires qui permettent une personnalisation tout en maintenant l\'efficacité de la production. Chaque unité est conçue pour s\'intégrer harmonieusement dans son environnement.',
        'opp.design.p2': 'L\'accent est mis sur les matériaux durables et les technologies économes en énergie, créant des maisons qui sont belles et responsables.',
        'opp.clients': 'Clients',
        'opp.partners': 'Partenaires',
        'opp.yourproject': 'Votre projet',
    ...
    en: {
        ...
        // OtherPeoplesPlaces project
        'opp.title': 'Other Peoples Places Finds',
        'opp.lead': 'Breaking Boundaries in High-End Modular Housing Design',
        'opp.intro.p1': 'Other Peoples Places represents a revolutionary approach to high-end modular housing, combining innovative design with sustainability and flexibility.',
        'opp.intro.p2': 'The project explores new possibilities in prefabricated construction, creating living spaces that are both luxurious and environmentally responsible.',
        'opp.design.title': 'Innovative Design',
        'opp.design.p1': 'The design incorporates modular systems that allow for customization while maintaining production efficiency. Each unit is designed to integrate harmoniously with its environment.',
        'opp.design.p2': 'Emphasis is placed on sustainable materials and energy-efficient technologies, creating homes that are both beautiful and responsible.',
        'opp.clients': 'Clients',
        'opp.partners': 'Partners',
        'opp.yourproject': 'Your Project',
